...
namespace SignCMD
{
    ...
    public class SignCommands : TerrariaPlugin
    {
        ...
        {
            get { return "Excute Commands through Signs!"; }
        }
        ...
        private void OnInitialize(EventArgs args)
        {
            ...
            var configPath = Path.Combine(savePath, "SC_Config.json");
        ...
        private void RemoveSign(CommandArgs args)
        {
        ...
        private void SCReload(CommandArgs args)
        {
            ...
            args.Player.SendSuccessMessage("[SC] Config Reloaded.");
        }
